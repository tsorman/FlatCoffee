...
public class FlatCoffeePercentageGaugePanel extends JPanel{
	private int value ;
	...
	public FlatCoffeePercentageGaugePanel() {
		setBackground(Color.WHITE);
		initElements ( ) ;
	}
	
	public FlatCoffeePercentageGaugePanel( String title) {
		this.title = title ;
		
		initElements ( ) ;
	}
	
	public FlatCoffeePercentageGaugePanel( String title , String displayValue , int value ) {
		this.title = title ;
//		this.displayValue = displayValue ;
	...
	private void initElements ( )
	{
		...
		FlatCoffeePercentageGaugeDrawLabel gauseDrawLabel = new FlatCoffeePercentageGaugeDrawLabel(56, "100", "0", "56") ;
		gauseDrawLabel.setGaugeposition(50);
